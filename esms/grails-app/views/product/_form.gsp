<%@ page import="com.esms.model.product.Product" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: productInstance, field: 'introductionDate', 'error')} required">
				<label for="introductionDate" class="control-label"><g:message code="product.introductionDate.label" default="Introduction Date" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<g:datePicker property="introductionDate" value="${productInstance?.introductionDate}" precision="day"></g:datePicker>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: productInstance, field: 'requiresInventory', 'error')} ">
				...
				<div class="controls">
					<bs:checkBox name="requiresInventory" value="${productInstance?.requiresInventory}" />
					<span class="help-inline">${hasErrors(bean: productInstance, field: 'requiresInventory', 'error')}</span>
				</div>
			</div>

			<div class="control-group fieldcontain ${hasErrors(bean: productInstance, field: 'salesDiscontinuationDate', 'error')} required">
				<label for="salesDiscontinuationDate" class="control-label"><g:message code="product.salesDiscontinuationDate.label" default="Sales Discontinuation Date" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<bs:datePicker name="salesDiscontinuationDate" precision="day"  value="${productInstance?.salesDiscontinuationDate}"  />
					<span class="help-inline">${hasErrors(bean: productInstance, field: 'salesDiscontinuationDate', 'error')}</span>
				</div>
			</div>

			<div class="control-group fieldcontain ${hasErrors(bean: productInstance, field: 'supportDiscontinuationDate', 'error')} required">
				<label for="supportDiscontinuationDate" class="control-label"><g:message code="product.supportDiscontinuationDate.label" default="Support Discontinuation Date" /><span class="required-indicator">*</span></label>
				<div class="controls">
					<bs:datePicker name="supportDiscontinuationDate" precision="day"  value="${productInstance?.supportDiscontinuationDate}"  />
