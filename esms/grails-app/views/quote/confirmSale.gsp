				...
				<fieldset>
					<div class="row">
						<div class="col-md-6">
							...
							<div
								class="form-group fieldcontain ${hasErrors(bean: quoteInstance, field: 'notes', 'error')} ">
								<label for="notes" class="col-md-3 control-label"><g:message
											code="quote.notes.label"
											default="Notes" /> </label>
								<div class="col-md-9">
									<g:textArea name="notes" class="form-control" value="${quoteInstance.notes}" />
