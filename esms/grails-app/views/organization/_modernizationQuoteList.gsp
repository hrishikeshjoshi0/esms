...
<div class="pull-right">
	<a href="<g:createLink controller="quote" action="create" params="[contractQuote:true,type:'MODERNIZATION',organizationId:organizationInstance?.id]"/>" 
		role="button" class="btn btn-default btn-xs"> <i class="glyphicon glyphicon-plus"></i> New Modernization Quote
	</a>
</div>
...
<table class="table table-striped table-condensed table-bordered">
	...
	<tbody>
		<g:each in="${Quote.findAllWhere(organization:organizationInstance,type:'MODERNIZATION')}" var="quoteInstance">
			<tr>
