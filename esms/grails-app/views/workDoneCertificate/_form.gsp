...
<div class="row">
	<div class="col-md-6">
		<div
			...
			<label for="date" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="customerName" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="contract" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="machineNumber" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="routeNumber" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="location" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="routineService" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="serviceCodeAttended" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="breakDownCall" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="callBackCodeAttended" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="arrivalTime" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="repairs" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="repairsWorkCompleted" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="ind_T_S_OrderExecution" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="ind_T_S_OrderExecutionWorkStarted" class="col-lg-2 control-label"><g:message
	...
	<div class="col-md-6">
		<div
			...
			<label for="buttonsAndSignals" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="carEntrance" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="carFanLight" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="carOperatingPanel" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="doorOperation" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="doorProtection" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="emergencyAlarm" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="entrance" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="floorLevels" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="machineRoom" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="rideQuality" class="col-lg-2 control-label"><g:message
...
<div class="row">
	<div class="col-md-12">
		...
		<div
			...
			<label for="examinerName" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="customerSignedOffBy" class="col-lg-2 control-label"><g:message
		...
		<div
			...
			<label for="customerRemark" class="col-lg-2 control-label"><g:message
