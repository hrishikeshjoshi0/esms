...
<div class="row">
	<div class="col-md-6">
		<div
			...
			<label for="date" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="customerName" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="contract" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="machineNumber" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="routeNumber" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="location" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="routineService" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="serviceCodeAttended" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="breakDownCall" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="callBackCodeAttended" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="arrivalTime" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="repairs" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="repairsWorkCompleted" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="ind_T_S_OrderExecution" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="ind_T_S_OrderExecutionWorkStarted" class="col-md-2 control-label"><g:message
	...
	<div class="col-md-6">
		<div
			...
			<label for="buttonsAndSignals" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="carEntrance" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="carFanLight" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="carOperatingPanel" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="doorOperation" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="doorProtection" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="emergencyAlarm" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="entrance" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="floorLevels" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="machineRoom" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="rideQuality" class="col-md-2 control-label"><g:message
...
<div class="row">
	<div class="col-md-12">
		...
		<div
			...
			<label for="examinerName" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="customerSignedOffBy" class="col-md-2 control-label"><g:message
		...
		<div
			...
			<label for="customerRemark" class="col-md-2 control-label"><g:message
