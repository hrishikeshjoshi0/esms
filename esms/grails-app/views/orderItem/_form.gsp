	...
	<tr>
		<td>
			<div
				...
				<label for="quantity" class="col-md-2 control-label"><g:message
	...
	<tr>
		...
		<td>
			<div
				...
				<label for="lineTotalAmount" class="col-md-2 control-label"><g:message
...
<%--<div
	...
	<label for="quote" class="col-md-2 control-label"><g:message
