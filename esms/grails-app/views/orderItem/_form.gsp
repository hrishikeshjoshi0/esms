...
<div
	...
	<div class="col-md-9">
		...
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'lineNumber', 'error')}
		</span>
	</div>
</div>
<div
	...
	<g:select name="productNumber" from="${Product.list()}"
		...
		class="form-control" noSelection="${['null':'Select Product..']}"
		value="${orderItemInstance?.productNumber}"
		onChange="fetchUnitPriceForProduct(this.value);" />
	<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'productNumber', 'error')}
	</span>
</div>
<div
	...
	<div class="col-md-9">
		<g:field type="number" name="quantity" step="any" required=""
			class="calc form-control" value="${orderItemInstance.quantity}" />
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'quantity', 'error')}
		</span>
	</div>
</div>
<div
	...
	<div class="col-md-9">
		<g:field type="number" name="unitPrice" step="any" required=""
			class="calc form-control" value="${orderItemInstance.unitPrice}" />
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'unitPrice', 'error')}
		</span>
	</div>
</div>
<div
	...
	<div class="col-md-9">
		<g:field type="number" name="tax" step="any" required=""
			class="calc form-control" value="${orderItemInstance.tax}" />
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'tax', 'error')}
		</span>
	</div>
</div>
<div
	...
	<div class="col-md-9">
		<g:field type="number" name="discount" step="any" required=""
			class="calc form-control" value="${orderItemInstance.discount}" />
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'discount', 'error')}
		</span>
	</div>
</div>
<div
	...
	<div class="col-md-9">
		...
		<span class="help-inline"> ${hasErrors(bean: orderItemInstance, field: 'lineTotalAmount', 'error')}
		</span>
	</div>
</div>
