<%@ page import="com.esms.model.party.PartyGroup" %>
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'description', 'error')} ">
				<label for="description" class="col-md-3 control-label"><g:message code="partyGroup.description.label" default="Description" /></label>
				<div class="col-md-9">
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'partyType', 'error')} ">
				<label for="partyType" class="col-md-3 control-label"><g:message code="partyGroup.partyType.label" default="Party Type" /></label>
				<div class="col-md-9">
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'status', 'error')} ">
				<label for="status" class="col-md-3 control-label"><g:message code="partyGroup.status.label" default="Status" /></label>
				<div class="col-md-9">
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'relationshipType', 'error')} ">
				<label for="relationshipType" class="col-md-3 control-label"><g:message code="partyGroup.relationshipType.label" default="Relationship Type" /></label>
				<div class="col-md-9">
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'groupName', 'error')} required">
				<label for="groupName" class="col-md-3 control-label"><g:message code="partyGroup.groupName.label" default="Group Name" /><span class="required-indicator">*</span></label>
				<div class="col-md-9">
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'addresses', 'error')} ">
				<label for="addresses" class="col-md-3 control-label"><g:message code="partyGroup.addresses.label" default="Addresses" /></label>
				<div class="col-md-9">
...
<g:link controller="address" action="create" params="['partyGroup.id': partyGroupInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'address.label', default: 'Address')])}</g:link>
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'contactMechs', 'error')} ">
				<label for="contactMechs" class="col-md-3 control-label"><g:message code="partyGroup.contactMechs.label" default="Contact Mechs" /></label>
				<div class="col-md-9">
...
<g:link controller="contactMech" action="create" params="['partyGroup.id': partyGroupInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'contactMech.label', default: 'ContactMech')])}</g:link>
			...
			<div class="form-group fieldcontain ${hasErrors(bean: partyGroupInstance, field: 'externalId', 'error')} ">
				<label for="externalId" class="col-md-3 control-label"><g:message code="partyGroup.externalId.label" default="External Id" /></label>
				<div class="col-md-9">
