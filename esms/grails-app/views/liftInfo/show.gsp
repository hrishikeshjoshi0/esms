			...
			<div class="panel panel-default">
				<div class="panel-body">
					<dl class="dl-horizontal">
						...
						<dd>
							<g:fieldValue bean="${liftInfoInstance}"
								field="liftControlSystem" />
						</dd>
						...
						<dt>
							<g:message code="liftInfo.carCapacity.label"
						...
						<dt>
							<g:message code="liftInfo.machineMake.label"
								default="Machine Make" />
						</dt>
						...
						<dt>
							<g:message code="liftInfo.noOfFloors.label"
								default="No Of Floors" />
						</dt>
						...
						<dt>
							<g:message code="liftInfo.organization.label"
