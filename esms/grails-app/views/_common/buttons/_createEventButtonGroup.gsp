		...
		<ul class="dropdown-menu" role="menu">
			<li><g:if test="${order?.type == 'REPAIR' }">
					<g:link  action="create"
						controller="event"
						params="['party.id':order?.organization.id,relatedTo:'ORDER',relatedToValue:order?.orderNumber,eventType:'REPAIR WORK']">
			...
			<li><g:if test="${order?.type == 'MODERNIZATION' }">
					<g:link  action="create"
						controller="event"
						params="['party.id':order?.organization.id,relatedTo:'ORDER',relatedToValue:order?.orderNumber,eventType:'MODERNIZATION WORK']">
			...
			<li><g:if test="${order?.type == 'SERVICE' }">
					<g:link  action="create"
						controller="event"
						params="['party.id':order?.organization.id,relatedTo:'ORDER',relatedToValue:order?.orderNumber,eventType:'BREAKDOWN CALL',assignedTo:order?.assignedTo]">
					...
					<g:link  action="create"
						controller="event"
						params="['party.id':order?.organization.id,relatedTo:'ORDER',relatedToValue:order?.orderNumber,eventType:'MAINTENANCE VISIT',assignedTo:order?.assignedTo]">
