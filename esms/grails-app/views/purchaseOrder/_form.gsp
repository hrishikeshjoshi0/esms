...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'type', 'error')} ">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'description', 'error')} ">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'issueDate', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'expiryDate', 'error')} ">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'totalAmount', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'totalTax', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'totalDiscount', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'grandTotal', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'termsAndConditions', 'error')} ">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'inventoryJournalEntries', 'error')} ">
	<label for="inventoryJournalEntries" class="control-label"><g:message
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'openGrandTotal', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'organization', 'error')} required">
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'paidGrandTotal', 'error')} required">
	<label for="paidGrandTotal" class="control-label"><g:message
...
<div
	class="control-group fieldcontain ${hasErrors(bean: purchaseOrderInstance, field: 'purchaseOrderItems', 'error')} ">
	<label for="purchaseOrderItems" class="control-label"><g:message
