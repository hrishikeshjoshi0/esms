<div class="pull-right">
	<a
		...
		role="button" class="btn btn-default btn-xs"> <i class="glyphicon glyphicon-plus"></i> New Event
	</a>
</div>
		...
		<g:each in="${organizationInstance?.events}" var="eventInstance">
			<tr>
				...
				<td class="link"><g:link controller="event" action="show"
						id="${eventInstance.id}" class="btn btn-default btn-xs">Show &raquo;</g:link></td>
			</tr>
		</g:each>
	</tbody>
</table>
