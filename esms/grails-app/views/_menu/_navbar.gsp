	...
	<div class="navbar navbar-fixed-top">
		<%--<div class="navbar-inner">
			<div class="container-fluid">
				<a class="brand" href="${createLink(uri: '/')}"> <img
					src="${resource(dir: 'images', file: 'venus_crm_logo.png')}"
					alt="${meta(name:'app.name')}" style="height: 40px; width: auto;" />
					<br />
				</a>
				<ul class="nav">
					<li class="dropdown"><a data-toggle="dropdown"
						class="dropdown-toggle" href="#"> <i
							class="icon-th-large icon-white"></i> Quick Links <b
							class="caret"></b>
					</a>
				...
				<ul class="nav user_menu pull-left" style="margin-left: 2px;">
					<li><g:form style="margin-top:10px;">
				...
				<ul class="nav user_menu pull-right" style="margin-left: 2px;">
					...
					<li><g:link class="dropdown-toggle" controller="logout">Log Out</g:link>
					</li>
