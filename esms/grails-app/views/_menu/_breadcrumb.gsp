...
<ul class="breadcrumb">
	...
	<g:else>
		<li><g:link controller="dashboard">
				<i class="icon-home"></i>HOME</g:link></li>

		<!--  -->
		<g:if
			test="${params.controller == 'organization' && organizationInstance}">
			<li><i class="icon-user"></i> <g:link controller="organization"
		...
		<g:elseif test="${params.controller == 'product' && productInstance}">
			<li><i class="icon-user"></i> <g:link controller="product"
		...
		<g:elseif test="${params.controller == 'employee' && paymentInstance}">
			<li><i class="icon-user"></i> <g:link controller="employee"
